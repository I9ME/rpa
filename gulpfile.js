...
gulp.task('watch', function() {
  ...
  gulp.watch(scssFile, ['sassdev', 'sassprod', 'sassprod2', 'editorstyle' ]);
...
gulp.task('default', ['sinc', 'sprite', 'sassdev', 'sassprod', 'sassprod2', 'editorstyle', 'fonts', 'scripts', 'images',  'watch' ]);
